...
analysis$sampleTable <- read.table(here("config/p22162_Lara_exp_design.txt"), header=T, stringsAsFactors = FALSE, sep="\t", quote='"')
...
pairwise_comparisons <- function(x, alpha=0.05){
  ...
  result <- results(analysis$ddsDrop, contrast = x, alpha = alpha, listValues = c(1, -1/4), filter=maxMinFilter(analysis$ddsDrop, intgroup = 'Group', comp = c('adenocarcinoma', 'squamous', 'small cell', 'plasmacytoid', 'sarcomatoid')))
  # if (class(x) == 'list'){
