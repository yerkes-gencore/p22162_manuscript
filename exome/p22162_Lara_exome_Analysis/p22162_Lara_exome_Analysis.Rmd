...
query_oncokb_api_check <- function(gene, mutation){
  ...
  token <- ##Please use your own token
  res_GET <- GET(url, 
...
pdf(file = 'outputs/tmb_figure.pdf', height = 7, width = 10)
tmb_figure <- tcgaCompare(samples.maf.tmb, cohortName = 'Emory - BCDD', capture_size = 42.988611)
# tmb_figure
dev.off()
```
